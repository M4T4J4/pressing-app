                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge {{ $order->status == 'En attente'
                                                    ? 'bg-secondary'
                                                        ...
                                                        : ($order->status == 'Prête'
                                                            ...
                                                            : ($order->status == 'Terminée'
                                                                ...
                                                                : ($order->status == 'Annulée'
                                                                    ? 'bg-danger'
                                                                    : 'bg-light text-dark')))) }}">{{ $order->status }}</span>
                                        </td>
                                        <td>{{ $order->pickup_date ? $order->pickup_date->format('d/m/Y H:i') : 'N/A' }}
                                        </td>
                                        <td>{{ $order->delivery_date ? $order->delivery_date->format('d/m/Y H:i') : 'N/A' }}
                                        </td>
